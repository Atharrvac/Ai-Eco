...
export const WasteDetection = () => {
  ...
  const simulateAIDetection = async () => {
    ...
    toast({
      ...
      description: `Found ${finalResult.item} - Earned ${finalResult.ecoCoins} EcoCoins!`,
      duration: 5000,
    });
  };
                ...
                <Card className="p-6 bg-gradient-to-r from-primary-light to-accent-light border border-primary/20 scale-in">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <div className="text-sm text-muted-foreground mb-2">Recycling Tips:</div>
                        <ul className="text-sm space-y-1">
                          {detectionResult.recyclingTips.map((tip, index) => (
